(function () {
    ...
    ProvasController.$inject = ['$q', '$route', '$routeParams', 'ProvasDataService', 'ProvasFactory', 'Canonico', 'ConcursosDataService', 'CargosDataService', 'CommonConstants'];

    function ProvasController($q, $route, $routeParams, ProvasDataService, ProvasFactory, Canonico, ConcursosDataService, CargosDataService,CommonConstants) {
        var vm = this;
        ...
        function getProva() {
            if ($routeParams.id !== undefined) {
                ProvasDataService.buscaProvaPorID($routeParams.id).success(function (result) {
